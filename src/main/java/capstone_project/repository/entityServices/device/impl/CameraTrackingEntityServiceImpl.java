...
import capstone_project.repository.repositories.device.CameraTrackingRepository;
...
public class CameraTrackingEntityServiceImpl implements CameraTrackingEntityService {
    ...
    @Override
    public List<CameraTrackingEntity> findByVehicleAssignmentId(UUID vehicleAssignmentId) {
        return cameraTrackingRepository.findByVehicleAssignmentId(vehicleAssignmentId);
    }
}
